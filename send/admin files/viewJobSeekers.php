...
include 'connection.php';
	...
	else 
	{
		...
		$selectSeekerQuery = "SELECT * FROM `resume`";
		$seekerResults = $conn -> query($selectSeekerQuery);
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">View All Job-seekers</h4>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="index.php">Admin</a></li>
                                    <li><a href="#">Job</a></li>
                                    <li class="active">View All Job-seekers</li>
                                </ol>
